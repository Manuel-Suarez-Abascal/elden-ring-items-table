...
This project was bootstrapped with [Create React App](https://github.com/facebook/create-react-app) & fetching data from [this Elden Ring API](https://docs.eldenring.fanapis.com/).
